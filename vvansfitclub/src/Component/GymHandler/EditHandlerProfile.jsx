...
import { editHandlerProfile } from "../../Redux/GymHandler/Action";
...
const EditHandlerProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("Edit Handler Profile Data:", formData);
      await dispatch(editHandlerProfile(formData, token));
      navigate(-1);
    } catch (err) {
  ...
  return (
    <div className="relative min-h-screen bg-black flex items-center justify-center px-4 py-10">
      ...
      <div className="relative z-10 w-full max-w-4xl bg-white/10 backdrop-blur-md text-white p-10 rounded-3xl shadow-xl border border-white/20">
        ...
        <h2 className="text-4xl font-bold mb-10 text-center">Edit Profile – Handler</h2>
...
export default EditHandlerProfile;
