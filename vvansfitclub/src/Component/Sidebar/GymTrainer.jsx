...
//   id:1 // You can change to any valid image URL
// };

const GymTrainerSidebar = ({ closeSidebar }) => {
...
const navItems = [
  ...
  {
    name: "Profile",
    path: `/home/trainerProfile/${user?.id}`,
    icon: <UserCircle className="w-5 h-5" />,
  },
  {
    name: "Add Workout Plan",
    path: "/home/addWorkout",
    icon: <FilePlus2 className="w-5 h-5" />, // Suggests adding a document/plan
  },
  {
    name: "Add Diet",
    path: "/home/addDiet",
    icon: <Salad className="w-5 h-5" />, // Looks more diet-related
  },
  {
    name: "All Workout Plans",
    path: "/home/allWorkout",
    icon: <ClipboardList className="w-5 h-5" />,
  },
  {
    name: "All Diet Charts",
    path: "/home/allDiet",
    icon: <ListTodo className="w-5 h-5" />,
  },
  {
    name: "Handle User's Diet",
    path: "/home/assignDietToUser",
    icon: <UserPlus className="w-5 h-5" />, // Represents user + assignment
  },
  {
    name: "Handle User's Workout",
    path: "/home/assignWorkoutToUser",
    icon: <Users className="w-5 h-5" />, // Represents user + control
  },
  {
    name: "Edit Profile",
    path: "/home/editTrainerProfile",
    icon: <UserCircle className="w-5 h-5" />,
  },
];
...
export default GymTrainerSidebar;
